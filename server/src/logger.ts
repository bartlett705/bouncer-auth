...
export class Logger {
  ...
  constructor(logLevel: number) {
    this.error = logLevel > 0 ? (...args: any) => console.log(error(...args)) : noOp
    this.warn =
      logLevel > 1 ? (...args: any) => console.log(warn(...args)) : noOp
    this.info =
      logLevel > 2 ? (...args: any) => console.log(info(...args)) : noOp
    this.debug =
      logLevel > 3 ? (...args: any) => console.log(debug(...args)) : noOp
    this.externalCall =
      logLevel > 3
